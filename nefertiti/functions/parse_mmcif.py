...
if __name__ == "__main__":
    ...
    auth_chains = False if args.no_auth_chains else True
    auth_residues = False if args.no_auth_residues else True
    data = parse_mmcif(
        open(args.mmcif_file).read(),
        auth_chains=auth_chains,
        auth_residues=auth_residues,
    )
    np.save(args.outfile, data, allow_pickle=False)
